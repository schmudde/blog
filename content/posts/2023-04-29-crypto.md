...
> The authors live and work in a country whose policies on cryptography have been shaped by decades of a secrecy mentality and covert control.
...
Cracking DES therefore is 272 page volume that was illegal in digital form, but could be used to crack the NIST standard encryption scheme called DES. One merely needed to follow the instructions to build the hardware and software - easier said than done.[^BASIC]
...
The DES cracker software was written in C.  Like the Bombe before it, this software is created to make mini, tries and finding a key. The number of tries in the best case scenario is reduced thanks to human intuition. Unlike the work published by Turing, this work does not benefit from a crib.
