...
I was born in Peoria, Illinois[^peoria] and currently live in Turin, Italy.[^turin] The interim years were spent in Iowa &rarr; Chicago &rarr; New York City &rarr; Berlin.
...
- **The Art of Living**: [Adam Lofbomm](https://lofbomm.substack.com/), [The Compass Needle](https://compassneedleblog.wordpress.com), [Meanwhile, Back in Peoria](https://www.meanwhilebackinpeoria.com/)
- **Computing and the Humanities**: [Knowing and Doing](http://www.cs.uni.edu/~wallingf/blog/index.html), [Veit Heller](http://blog.veitheller.de/), [esoteric.codes](https://esoteric.codes), [Modulo Lotus](http://www.modulolotus.net), [Daniel Bachler](http://danielbachler.de/), [John Jacobsen](http://zerolib.com), [Ryan Singer](https://m.signalvnoise.com/author/ryan-singer/), [Protesilaos](https://protesilaos.com/).
...
All my highlights go into my knowledge base which relies on a combination of Protesilaos' excellent [Denote](https://protesilaos.com/emacs/denote) package for Emacs and Deft.
